...
<table border="2">
<tr><td width="250"><iframe src="chat.php" width="245" height="350" id="chat"></iframe></td></tr>
<tr><td width="250"><input name="text" type="text" size="18" onmousedown="if(event.button == '0'){document.form.text.value = ''}"><input type="submit" name="odeslat" value="Odeslat" onclick="kontrola()"></form><input id="submit" name="submit" type="button" value="==" title="Nastavení" onclick="document.getElementById('setting').style.display = 'block'"></td></tr>
</table>
<?php
